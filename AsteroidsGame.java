...
public class AsteroidsGame extends JPanel implements ActionListener, KeyListener {
    ...
    {
        Clip shootSound = loadSound("laser-gun_sound.wav");
        if (shootSound != null) 
        {
            shootSound.start();
        }
...
class Spaceship 
{
    ...
    public void draw(Graphics g) 
    {
        ...
        GeneralPath spaceshipShape = new GeneralPath();
        spaceshipShape.moveTo(x, y);
        spaceshipShape.lineTo(x + 20, y - 30);
        spaceshipShape.lineTo(x + 40, y);
        spaceshipShape.lineTo(x + 20, y + 15);
        spaceshipShape.lineTo(x, y);

        AffineTransform transform = AffineTransform.getRotateInstance(Math.toRadians(direction + 90), x, y);
        spaceshipShape.transform(transform);

        g2d.setColor(Color.BLUE);
        g2d.fill(spaceshipShape);
    }

    public boolean intersects(Asteroid asteroid) 
    {
        Rectangle spaceshipRect = new Rectangle(x, y, 30, 30);
